...
tubes_target <- read.csv(here('data/raw', '00_setup_0-tubes-masses.csv'), header=TRUE)
moisture <- read.csv(here('data/raw','00_moisture.csv'), heade =TRUE)
tubes_randomized <- read.csv(here('data/raw','00_setup_1-tubes-randomized.csv'), header=TRUE)
...
write.csv(tubes_target, file = here('data/raw data', 'tubes_target.csv'), row.names=FALSE)
...
write.csv(tubes_setup, file=here('data/raw data', 'tubes_moistening.csv'), row.names=FALSE)
